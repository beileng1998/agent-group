...
import type { DesktopBridge } from "@agent-group/contracts";
...
const AUTH_REQUEST_CHANNEL = "desktop:auth-request";
...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  server: {
    requestAuthJson: (input) => ipcRenderer.invoke(AUTH_REQUEST_CHANNEL, input),
