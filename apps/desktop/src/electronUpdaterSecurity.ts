...
import { prepareWindowsSafeProcess, resolveWindowsSystemRoot } from "@agent-group/shared/windowsProcess";
...
export function hardenElectronUpdater(
  ...
  const prototype =
    typeof updaterModule.BaseUpdater === "function"
      ...
      : null;
  if (prototype && !prototype.__agentGroupSpawnSyncLogPatched) {
    ...
    prototype.__agentGroupSpawnSyncLogPatched = true;
  }
