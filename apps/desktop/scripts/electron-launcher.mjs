// This file mostly exists so development builds have the correct app identity.
...
import { agentGroupBundleId } from "@agent-group/shared/desktopIdentity";
import { dirname, join, resolve } from "node:path";
import { fileURLToPath } from "node:url";

const isDevelopment = Boolean(process.env.VITE_DEV_SERVER_URL);
const APP_DISPLAY_NAME = isDevelopment ? "Agent Group (Dev)" : "Agent Group";
const APP_BUNDLE_ID = agentGroupBundleId(isDevelopment);
