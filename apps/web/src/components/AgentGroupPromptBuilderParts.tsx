  ...
  return (
    <div>
      ...
      <PromptXmlEditor
        ...
        {...(props.protectedAfter !== undefined ? { protectedAfter: props.protectedAfter } : {})}
    ...
    <div className="overflow-hidden rounded-xl border border-border bg-background/25">
      <div className="flex items-start justify-between gap-3 border-b border-border p-3">
        ...
        <div className="inline-flex rounded-lg bg-muted/45 p-0.5" role="tablist">
          <PromptViewTab
            active={props.turn === "first"}
            onClick={() => props.onTurnChange("first")}
          >
            First
          </PromptViewTab>
          <PromptViewTab
            active={props.turn === "later"}
            onClick={() => props.onTurnChange("later")}
          >
            Later
          </PromptViewTab>
        </div>
