...
export function AgentGroupSettingsPanel() {
  ...
  const [draft, setDraft] = useState<AgentGroupServerSettings>(DEFAULT_AGENT_GROUP_SETTINGS);
  const [saved, setSaved] = useState<AgentGroupServerSettings>(DEFAULT_AGENT_GROUP_SETTINGS);
