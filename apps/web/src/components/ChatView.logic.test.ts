import { CheckpointRef, EventId, ThreadId, TurnId, type ModelSlug } from "@agent-group/contracts";
...
describe("file undo completion", () => {
  ...
  const summary = {
    ...
    checkpointRef: CheckpointRef.makeUnsafe("refs/agent-group/checkpoints/thread-file-undo/turn/2"),
