...
import { type TerminalActivityState, type TerminalCliKind } from "@agent-group/shared/terminalThreads";
...
export interface ThreadTerminalViewportProps {
  threadId: ThreadId;
  terminalId: string;
...
export function ThreadTerminalViewport({
  threadId,
  terminalId,
  terminalLabel,
