...
import { ArrowRightIcon, LayoutSidebarIcon, MessageCircleIcon, PencilIcon } from "~/lib/icons";
...
interface TranscriptSelectionActionProps {
  ...
  onAddToChat: () => void;
  onAddToSidechat?: (() => void) | undefined;
  onAskInSidechat?: (() => void) | undefined;
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {props.onAddToSidechat ? (
          <TranscriptSelectionToolbarButton label="Add to Side" onClick={props.onAddToSidechat}>
            <ArrowRightIcon className="size-3.5" />
          </TranscriptSelectionToolbarButton>
        ) : null}
        {props.onAskInSidechat ? (
          <TranscriptSelectionToolbarButton label="Ask in Side" onClick={props.onAskInSidechat}>
