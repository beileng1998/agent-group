...
import { AGENT_GROUP_DOCK_KINDS } from "~/agentGroupCapabilities";
...
export const RIGHT_DOCK_PANE_META: Record<RightDockPaneKind, RightDockPaneMeta> = {
  context: { label: "Session", Icon: FileIcon },
  highlights: { label: "Highlights", Icon: HighlightIcon },
  group: { label: "Group", Icon: SettingsIcon },
...
export const RIGHT_DOCK_ADD_MENU_KINDS: readonly RightDockPaneKind[] =
  AGENT_GROUP_DOCK_KINDS.filter((kind) => kind !== "context");
