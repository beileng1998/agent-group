...
//          control GitPanel so they share font/theme behavior, the Agent Group file
...
// A single themed file diff with Agent Group's custom file header. Bakes in the shared
