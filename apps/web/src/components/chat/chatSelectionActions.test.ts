...
describe("chatSelectionActions", () => {
  ...
  it("uses DOM source offsets for multi-line Markdown blocks", () => {
    const messageText = "- First saved line\n- Second saved line";

    expect(
      resolveTranscriptMarkerRange({
        messageText,
        selectedText: "First saved line\nSecond saved line",
        sourceRange: {
          startOffset: messageText.indexOf("First"),
