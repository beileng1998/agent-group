...
//          read-only preview. Mirrors Codex's per-line comment box: an Agent Group
...
import { AgentGroupLogo } from "../AgentGroupLogo";
      ...
      <div className="flex items-center justify-between gap-2">
        <span className="inline-flex items-center gap-2 text-[13px] font-semibold text-[var(--color-text-foreground)]">
          <span className="editor-file-viewer__comment-badge">
            <AgentGroupLogo className="size-3 text-[var(--color-text-foreground-secondary)]" />
          </span>
          Local comment
        </span>
