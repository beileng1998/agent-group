...
import { CHAT_SURFACE_HEADER_HEIGHT_PX } from "@agent-group/shared/desktopChrome";
 ...
 * `@agent-group/shared/desktopChrome` (the single source of truth the Electron main
