...
/** Slide timing shared with every open/close disclosure. */
export const ENVIRONMENT_PANEL_MOTION_CLASS = DISCLOSURE_CONTENT_MOTION_CLASS;

/** Transcript/composer right inset when the docked Environment card opens. */
export const ENVIRONMENT_CONTENT_INSET_MOTION_CLASS = DISCLOSURE_INSET_MOTION_CLASS;
