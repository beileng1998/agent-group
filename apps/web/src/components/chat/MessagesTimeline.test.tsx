...
import { CheckpointRef, MessageId, TurnId } from "@agent-group/contracts";
...
describe("MessagesTimeline", () => {
  ...
  it("renders Claude agent task output through the shared markdown renderer", async () => {
    ...
    expect(markup).toContain(">Complete File-Icon Rendering Map</span></h2>");
            ...
            [
              assistantMessageId,
              {
                ...
                checkpointRef: CheckpointRef.makeUnsafe(
                  "refs/agent-group/checkpoints/thread/turn/1",
                ),
                status: "ready",
                completedAt: "2026-03-17T19:12:30.000Z",
                assistantMessageId,
