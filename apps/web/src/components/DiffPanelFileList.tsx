...
import { isSupportedLocalImagePath } from "@agent-group/shared/localPreviewFiles";
...
function DiffFileCollapseChevron(props: { collapsed: boolean }) {
  return (
    <span className="inline-flex items-center p-0.5 text-inherit">
      <DisclosureChevron open={!props.collapsed} className="size-3.5 opacity-50" />
    </span>
  );
}
