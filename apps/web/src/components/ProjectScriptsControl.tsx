...
import { ChevronDownIcon, PlusIcon, SettingsIcon } from "~/lib/icons";
...
} from "./project-scripts/projectScriptEditorValues";

export type { NewProjectScriptInput } from "./project-scripts/projectScriptEditorValues";
