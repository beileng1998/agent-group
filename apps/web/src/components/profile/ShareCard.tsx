...
import type { ProfileStats, ProfileTokenStats } from "@agent-group/contracts";
import { ProviderIcon } from "~/components/ProviderIcon";
import { AgentGroupLogo } from "~/components/AgentGroupLogo";
    ...
    >
      ...
      <div className="flex min-w-0 items-center justify-between gap-6">
        ...
        <div className="flex shrink-0 items-center gap-2 text-slate-600">
          <AgentGroupLogo className="size-6 text-slate-700" />
          <span className="text-xl font-normal tracking-tight">Agent Group</span>
        </div>
      </div>
