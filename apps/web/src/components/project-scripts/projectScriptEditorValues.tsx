// FILE: projectScriptEditorValues.tsx
// Purpose: Project-script icon catalog and keyboard shortcut capture helpers.
// Layer: Web project actions UI

import type { ProjectScriptIcon } from "@agent-group/contracts";
