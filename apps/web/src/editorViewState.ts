...
const EDITOR_VIEW_STATE_STORAGE_KEY = "agent-group.editor.viewStateByThreadId";
const EDITOR_RAIL_CHAT_TABS_STORAGE_KEY = "agent-group.editor.railChatTabsByProjectId";
