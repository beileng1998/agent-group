...
async function dispatchMarkerCommand(
  command:
    ...
    | {
        readonly type: "thread.marker.color.set";
        readonly threadId: ThreadId;
        readonly markerId: ThreadMarkerId;
        readonly color: ThreadMarkerColor;
      }
    | {
        readonly type: "thread.marker.note.set";
        readonly threadId: ThreadId;
        readonly markerId: ThreadMarkerId;
...
export function dispatchThreadMarkerColorSet(
  threadId: ThreadId,
  markerId: ThreadMarkerId,
  color: ThreadMarkerColor,
): Promise<void> {
  return dispatchMarkerCommand({ type: "thread.marker.color.set", threadId, markerId, color });
}

export function dispatchThreadMarkerNoteSet(
  threadId: ThreadId,
  markerId: ThreadMarkerId,
  note: string | null,
): Promise<void> {
  return dispatchMarkerCommand({
    ...
    threadId,
    markerId,
    note: normalizeThreadMarkerNote(note),
  });
}
