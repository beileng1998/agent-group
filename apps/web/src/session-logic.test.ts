...
describe("deriveWorkLogEntries", () => {
  ...
  it("keeps created-automation milestones and exposes their card fields despite a null turn id", () => {
    const activities: OrchestrationThreadActivity[] = [
      ...
      makeActivity({
        ...
        summary: "Created automation: Watch Agent Group PR 231 - Every 5m",
        tone: "info",
        payload: {
          source: "chat-composer",
          automationId: "automation-7",
          automationName: "Watch Agent Group PR 231",
              ...
              commandActions: [
                {
                  ...
                  name: "README.md",
                  path: "/Users/tester/Developer/agent-group/README.md",
                },
              ],
            },
          },
  ...
  it("humanizes Codex commands with a complete persisted payload shape", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
        ...
        payload: {
          ...
          data: {
            item: {
              ...
              command: "/bin/zsh -lc 'git status --short'",
              cwd: "/Users/tester/Developer/agent-group",
              status: "completed",
              commandActions: [{ type: "unknown", command: "git status --short" }],
...
describe("PROVIDER_OPTIONS", () => {
  ...
  it("humanizes Codex find commands from a persisted payload (regression)", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
