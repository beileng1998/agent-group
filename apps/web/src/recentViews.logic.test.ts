...
import type { ResolvedTerminalVisualIdentity } from "@agent-group/shared/terminalThreads";
import {
...
describe("recent view MRU logic", () => {
  ...
  it("prefers terminal visual identity over thread provider for display icons", () => {
    ...
    const project = { id: projectId("project-1"), name: "Agent Group" } as Project;
    const threadSummary = {
      id: terminalThreadId,
