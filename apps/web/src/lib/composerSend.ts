...
import { applyClaudePromptEffortPrefix, getModelCapabilities } from "@agent-group/shared/model";
...
} from "../composerDraft/composerDraftContracts";
...
export { cloneComposerImageAttachment } from "../composerDraft/composerDraftImageLifecycle";
