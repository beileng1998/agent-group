...
import { CHAT_ASSISTANT_SELECTION_TEXT_MAX_CHARS, type ThreadId } from "@agent-group/contracts";
...
export const CHAT_FILE_REFERENCE_DRAG_TYPE = "application/x-agent-group-file-reference";
