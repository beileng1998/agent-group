...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "agent-group:cursor-favourite-models:v1",
  kilo: "agent-group:kilo-favourite-models:v1",
  opencode: "agent-group:opencode-favourite-models:v1",
  pi: "agent-group:pi-favourite-models:v1",
} as const;
