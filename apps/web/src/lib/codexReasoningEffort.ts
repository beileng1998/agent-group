import type { ProviderKind, ProviderModelDescriptor } from "@agent-group/contracts";
import { getModelCapabilities, hasEffortLevel, trimOrNull } from "@agent-group/shared/model";
