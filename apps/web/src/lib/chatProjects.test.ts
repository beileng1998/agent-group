...
describe("isHomeChatContainerProject", () => {
  it("matches the managed Documents/Agent Group general-chat root used by older drafts", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Agent Group",
          kind: "chat",
          name: "Home",
          remoteName: "Home",
        },
  ...
  it("matches Codex-style date/slug chat workspaces under Documents/Agent Group", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Agent Group/2026-06-11/yes-it-takes-all-the-skills",
          kind: "chat",
          name: "Yes it takes",
  ...
  it("trusts the chat kind before any server workspace path resolves", () => {
    ...
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Agent Group/2026-06-11/some-chat",
          kind: "chat",
          name: "Some chat",
  ...
  it("does not classify ordinary projects under Documents/Agent Group as home chat containers", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Agent Group",
