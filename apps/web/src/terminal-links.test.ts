...
describe("resolvePathLinkTarget", () => {
  it("resolves relative paths against cwd", () => {
    ...
    ).toBe("/Users/tester/project/src/components/ThreadTerminalDrawer.tsx:42:7");
  });

  it("keeps absolute paths unchanged", () => {
    expect(
      resolvePathLinkTarget("/Users/tester/project/src/main.ts:12", "/Users/tester/project"),
    ).toBe("/Users/tester/project/src/main.ts:12");
  });
});
