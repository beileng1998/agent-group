        ...
        (thread) => {
          ...
          if (
            ...
            (event.payload.goalStartedAt === undefined ||
              event.payload.goalStartedAt === (thread.goalStartedAt ?? null)) &&
            (event.payload.goalPausedAt === undefined ||
              event.payload.goalPausedAt === (thread.goalPausedAt ?? null)) &&
            (event.payload.goalAchievements === undefined ||
              deepEqualJson(event.payload.goalAchievements, thread.goalAchievements ?? [])) &&
