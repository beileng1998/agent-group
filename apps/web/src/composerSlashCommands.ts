import type { GitBranch, ProviderKind } from "@agent-group/contracts";
import {
...
} from "@agent-group/shared/composerSlashCommands";
  ...
  const availableCommands: ComposerSlashCommand[] =
    input.provider !== "claudeAgent"
      ...
      : [
          ...
          // creates an Agent Group split/context clone before the provider sees the first turn.
          // /export is app-level too — Agent Group owns the thread transcript, so the download
