...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  // ── Agent Group ────────────────────────────────────────────────────────────
  {
    id: "agent-group:default-agent",
    section: "agent-group",
    title: "Default Agent",
    keywords: "Default model provider new Group Session",
    target: null,
  },
  {
    id: "agent-group:context-templates",
    section: "agent-group",
    title: "Context templates",
    keywords: "Session context template library add edit delete Markdown",
    target: null,
  },
  {
    id: "agent-group:prompt-assembly",
    section: "agent-group",
    title: "Prompt assembly",
    keywords:
      "Visual prompt blocks user request context parent mentions browser tools global rules preview",
    target: null,
  },
  ...
  // ── Appearance ───────────────────────────────────────────────────────────────
  {
    ...
    section: "appearance",
    title: "Theme",
    keywords: "Choose how Agent Group looks across the app. dark light system color",
  },
  {
  ...
  {
    id: "appearance:default-highlight-color",
    section: "appearance",
    title: "Default highlight color",
    keywords:
      "Color used when you highlight transcript text. recolor remove marker yellow blue green pink",
    target: null,
  },
  {
  ...
  // ── Mobile access ─────────────────────────────────────────────────────────────
  {
    id: "access:mobile-access",
    section: "access",
    title: "Mobile access",
    keywords: "tailscale tailnet remote phone pwa private network vpn",
  },
  {
    id: "access:pairing",
    section: "access",
    title: "One-time pairing code",
    keywords: "qr code pair iphone ipad android device token",
  },
  // ── AppSnap ───────────────────────────────────────────────────────────────────
  {
    id: "appsnap:enable",
  ...
  // ── Keyboard Shortcuts ────────────────────────────────────────────────────────
  {
    ...
    keywords:
      "Every keyboard shortcut available in Agent Group, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Agent Group. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Agent Group can safely update. upgrade cli",
  },
  {
...
export function rankSettingsSearchEntries(
  ...
  const ranked = rankProviderDiscoveryItems(
    SETTINGS_SEARCH_ENTRIES.filter((entry) => isVisibleSettingsSection(entry.section)),
    trimmed,
    (entry) => [
      { value: entry.title },
