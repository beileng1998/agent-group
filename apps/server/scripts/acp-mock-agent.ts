...
const requestLogPath = process.env.AGENT_GROUP_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.AGENT_GROUP_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.AGENT_GROUP_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.AGENT_GROUP_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitUpstreamAssistantMessageIds =
  process.env.AGENT_GROUP_ACP_EMIT_UPSTREAM_ASSISTANT_MESSAGE_IDS === "1";
const emitReasoningThenToolCall = process.env.AGENT_GROUP_ACP_EMIT_REASONING_THEN_TOOL_CALL === "1";
const emitGenericToolPlaceholders = process.env.AGENT_GROUP_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitAskQuestion = process.env.AGENT_GROUP_ACP_EMIT_ASK_QUESTION === "1";
const failSetConfigOption = process.env.AGENT_GROUP_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.AGENT_GROUP_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.AGENT_GROUP_ACP_PROMPT_RESPONSE_TEXT;
const supportsSessionResume = process.env.AGENT_GROUP_ACP_SUPPORT_SESSION_RESUME === "1";
const supportsSessionLoad = process.env.AGENT_GROUP_ACP_SUPPORT_SESSION_LOAD !== "0";
const supportsSessionFork = process.env.AGENT_GROUP_ACP_SUPPORT_SESSION_FORK === "1";
const emitAvailableCommands = process.env.AGENT_GROUP_ACP_EMIT_AVAILABLE_COMMANDS === "1";
const modeConfigId = process.env.AGENT_GROUP_ACP_MODE_CONFIG_ID || "mode";
