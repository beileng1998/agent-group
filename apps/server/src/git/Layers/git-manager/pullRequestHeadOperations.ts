...
import type { PullRequestHeadRemoteInfo, ResolvedPullRequest } from "./gitManagerTypes.ts";

export function makePullRequestHeadOperations(deps: {
  ...
  return { configurePullRequestHeadUpstream, materializePullRequestHeadBranch };
}
