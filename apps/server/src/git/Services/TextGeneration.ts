...
export class CodexTextGeneration extends ServiceMap.Service<
  CodexTextGeneration,
  TextGenerationShape
>()("agent-group/git/Services/TextGeneration/CodexTextGeneration") {}
...
export class OpenCodeTextGeneration extends ServiceMap.Service<
  ...
  TextGenerationShape
>()("agent-group/git/Services/TextGeneration/OpenCodeTextGeneration") {}
...
export class KiloTextGeneration extends ServiceMap.Service<
  KiloTextGeneration,
  TextGenerationShape
>()("agent-group/git/Services/TextGeneration/KiloTextGeneration") {}
