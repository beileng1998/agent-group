...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@agent-group/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Agent Group uses its isolated
 ...
 * overlay `<AGENT_GROUP_HOME>/codex-home-overlay/generated_images` so we serve
