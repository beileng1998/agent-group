    ...
    return Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
          authMethodId: "test",
          requestLogger: (event) =>
            Effect.sync(() => {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { AGENT_GROUP_ACP_SUPPORT_SESSION_RESUME: "1" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { AGENT_GROUP_ACP_SUPPORT_SESSION_LOAD: "0" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: [mockAgentPath],
            env: {
              AGENT_GROUP_ACP_SUPPORT_SESSION_FORK: "1",
              AGENT_GROUP_ACP_EMIT_AVAILABLE_COMMANDS: "1",
              AGENT_GROUP_ACP_MODE_CONFIG_ID: "autonomy_level",
            },
          },
          cwd: process.cwd(),
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: [mockAgentPath],
            env: {
              AGENT_GROUP_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: [mockAgentPath],
            env: {
              AGENT_GROUP_ACP_EMIT_UPSTREAM_ASSISTANT_MESSAGE_IDS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: [mockAgentPath],
            env: {
              AGENT_GROUP_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: [mockAgentPath],
            env: {
              AGENT_GROUP_ACP_EMIT_REASONING_THEN_TOOL_CALL: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "agent-group-test", version: "0.0.0" },
