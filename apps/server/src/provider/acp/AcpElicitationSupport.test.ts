...
// Purpose: Verifies ACP form schemas and Agent Group answers round-trip without losing primitive types.
...
describe("ACP elicitation mapping", () => {
  it("maps primitive form fields to Agent Group questions", () => {
