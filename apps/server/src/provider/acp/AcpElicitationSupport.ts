...
// Purpose: Bridges ACP form elicitation schemas to Agent Group's provider-neutral question UI.
// Layer: Provider ACP protocol mapping
// Exports: question extraction and typed ACP response construction.

import type { ProviderUserInputAnswers, UserInputQuestion } from "@agent-group/contracts";
...
// Converts primitive ACP form fields into the question shape consumed by Agent Group's composer.
