...
export interface ProviderTranscriptPathInput {
  readonly threadId: ThreadId;
...
export interface ProviderAdapterShape<TError> {
  ...
  /** Resolve a provider-native transcript file without starting a session. */
  readonly resolveTranscriptPath?: (
    input: ProviderTranscriptPathInput,
  ) => Effect.Effect<string | null, TError>;
