...
describe("linkOrCopyCodexOverlayEntry", () => {
  it("copies auth.json when symlink creation is unavailable", () => {
    ...
    linkOrCopyCodexOverlayEntry(
      {
        ...
        targetPath: "C:\\Users\\test\\.agent-group\\codex-home-overlay\\auth.json",
        type: "file",
      },
      { symlink, copyFile },
    );
    ...
    expect(symlink).toHaveBeenCalledWith(
      ...
      "C:\\Users\\test\\.agent-group\\codex-home-overlay\\auth.json",
      "file",
    );
      ...
      linkOrCopyCodexOverlayEntry(
        {
          ...
          targetPath: "C:\\Users\\test\\.agent-group\\codex-home-overlay\\sessions",
          type: "dir",
        },
