...
import Migration0055 from "./Migrations/055_ProjectionThreadHighlights.ts";
import Migration0056 from "./Migrations/056_ProjectionThreadsGoal.ts";
...
export const migrationEntries = [
  ...
  [55, "ProjectionThreadHighlights", Migration0055],
  [56, "ProjectionThreadsGoal", Migration0056],
] as const;
 ...
 * once the imported tracker's high-water mark reaches Agent Group's latest ID,
 * every Agent Group migration is skipped silently and startup crashes on missing
 ...
 *
 * Instead, compare the recorded (id, name) pairs against Agent Group's lineage and
...
export const reconcileMigrationLineage = Effect.gen(function* () {
  ...
  yield* Effect.logWarning(
    "Migration tracker diverges from the Agent Group lineage (legacy import); re-running migrations from the divergence point",
