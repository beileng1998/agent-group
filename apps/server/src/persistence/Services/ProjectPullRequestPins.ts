 ...
 */
import { PositiveInt, ProjectId, TrimmedNonEmptyString } from "@agent-group/contracts";
...
>()("agent-group/persistence/Services/ProjectPullRequestPins/ProjectPullRequestPins") {}
