 ...
 * names. Because the migrator skips by ID, Agent Group migrations 17-31 never run
 ...
 * Agent Group migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Agent Group installs (every column already
