...
describe("orchestration projector", () => {
  ...
  it("adopts a different provider for a later turn", async () => {
    const createdAt = "2026-02-23T08:00:00.000Z";
    const startedAt = "2026-02-23T08:00:02.000Z";
    const turnRequestedAt = "2026-02-23T08:00:05.000Z";
    const running = await projectThreadWithRunningTurn({ createdAt, startedAt });
      ...
      projectEvent(
        ...
        makeEvent({
          ...
          payload: {
            ...
            turnId: "turn-0",
            checkpointTurnCount: 1,
            checkpointRef: "refs/agent-group/checkpoints/thread-1/turn/0",
            status: "ready",
            files: [],
      ...
      projectEvent(
        ...
        makeEvent({
          ...
          payload: {
            ...
            turnId: "turn-1",
            checkpointTurnCount: 1,
            checkpointRef: "refs/agent-group/checkpoints/thread-1/turn/1",
            status: "ready",
            files: [],
            assistantMessageId: null,
    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      ...
      makeEvent({
        ...
        payload: {
          ...
          checkpointRef: "refs/agent-group/checkpoints/thread-1/turn/2",
          status: "ready",
          files: [],
    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-1",
          checkpointTurnCount: 1,
          checkpointRef: "refs/agent-group/checkpoints/thread-revert/turn/1",
          status: "ready",
          files: [],
      ...
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-2",
          checkpointTurnCount: 2,
          checkpointRef: "refs/agent-group/checkpoints/thread-revert/turn/2",
          status: "ready",
          files: [],
      ...
      (_, index) =>
        makeEvent({
          ...
          payload: {
            ...
            checkpointRef: `refs/agent-group/checkpoints/thread-capped/turn/${index + 1}`,
            status: "ready",
            files: [],
