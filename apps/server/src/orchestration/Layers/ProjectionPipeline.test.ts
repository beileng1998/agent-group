...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer(
  "agent-group-projection-pipeline-test-",
);
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("agent-group-projection-pipeline-approvals-"),
  ),
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-overwrite-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-rollback-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-revert-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-delete-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("agent-group-projection-pipeline-turn-finish-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
