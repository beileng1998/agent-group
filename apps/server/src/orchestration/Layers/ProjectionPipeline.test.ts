...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("agent-group-projection-pipeline-test-");
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "agent-group-projection-pipeline-fast-forward-",
        }),
        NodeServices.layer,
      ),
    ),
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-base-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-pipeline-approvals-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-safe-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.effect("restores pending turn-start metadata across projection pipeline restart", () =>
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "agent-group-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "agent-group-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("agent-group-projection-pipeline-turn-finish-")),
)("OrchestrationProjectionPipeline", (it) => {
