import { CheckpointRef, EventId, MessageId, ProjectId, ThreadId, TurnId } from "@agent-group/contracts";
...
projectionSnapshotLayer("ProjectionSnapshotQuery", (it) => {
  ...
  it.effect("normalizes imported Agent Group model-selection shapes from projection reads", () =>
    Effect.gen(function* () {
      const snapshotQuery = yield* ProjectionSnapshotQuery;
      const sql = yield* SqlClient.SqlClient;
    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES (
          ...
          'Thread with PR',
          '{"provider":"codex","model":"gpt-5-codex"}',
          '{"number":1,"title":"Add placeholder temp files","url":"https://github.com/example/project/pull/1","baseBranch":"main","headBranch":"feature/greeting-1","state":"open"}',
          '2026-02-25T00:00:02.000Z',
          '2026-02-25T00:00:03.000Z',
          NULL
        )
      ...
      assert.equal(shellSnapshot.threads[0]?.lastKnownPr?.headBranch, "feature/greeting-1");
    }),
  );
