...
// Purpose: Normalizes provider-native transcript snapshots into Agent Group import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@agent-group/contracts";
