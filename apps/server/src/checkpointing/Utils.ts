...
import { resolveThreadWorkspaceCwd as resolveSharedThreadWorkspaceCwd } from "@agent-group/shared/threadEnvironment";

export const CHECKPOINT_REFS_PREFIX = "refs/agent-group/checkpoints";
