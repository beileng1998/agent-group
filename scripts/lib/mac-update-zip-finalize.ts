...
export async function finalizeMacUpdateZip(
  ...
  const manifestOptions =
    options.requireManifest === undefined ? {} : { required: options.requireManifest };
  for (const manifestName of resolveMacUpdateManifestFileNames(distEntries, manifestOptions)) {
