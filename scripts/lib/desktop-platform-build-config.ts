...
export const MICROPHONE_USAGE_DESCRIPTION =
  "Agent Group needs microphone access so you can record voice notes and transcribe them into the chat composer.";
...
export const MAC_APPSNAP_HELPER_BUNDLE_PATH = "Contents/Helpers/agent-group-appsnap-helper";
export const TAILNET_SIDECAR_STAGE_PATH = "apps/desktop/native/tailnet/build/agent-group-tailnet";
export const TAILNET_SIDECAR_WINDOWS_STAGE_PATH = `${TAILNET_SIDECAR_STAGE_PATH}.exe`;
export const TAILNET_SIDECAR_MAC_BUNDLE_PATH = "Contents/Resources/tailnet/agent-group-tailnet";
export const MAC_UNIVERSAL_NATIVE_FILES_PATTERN = `{${MAC_APPSNAP_HELPER_BUNDLE_PATH},${TAILNET_SIDECAR_MAC_BUNDLE_PATH}}`;
...
export function createDesktopPlatformBuildConfig(
  ...
  if (input.platform === "mac") {
    const mac = {
      ...
      x64ArchFiles: MAC_UNIVERSAL_NATIVE_FILES_PATTERN,
      extendInfo: {
