...
// the shareable activity card. All metrics are backed by Agent Group's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Agent Group.
...
// Token totals come from Agent Group's projected context-window updates. `available`
