...
const PATH_CAPTURE_START = "__AGENT_GROUP_PATH_START__";
const PATH_CAPTURE_END = "__AGENT_GROUP_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__AGENT_GROUP_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__AGENT_GROUP_ENV_${name}_END__`;
}
